...
#warning Warning: The GameSparks SDK only supports "Scripting Runtime Version.NET 3.5 Equivalent" and Api compatibility level 2.0, and you are not using those settings. However, this doesn't appear to cause any issues.");
#endif
