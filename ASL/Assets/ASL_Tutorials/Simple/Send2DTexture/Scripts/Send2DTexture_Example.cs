...
namespace SimpleDemos
{
    ...
    public class Send2DTexture_Example : MonoBehaviour
    {
        ...
        /// <summary>Start function is used to set up the button lister</summary>
        void Start()
        {
        ...
        /// <summary>
        /// An example of how to send a Texture2D. Important: The Texture2D being sent must be smaller than 3.5 GB (GameSparks rule)
        ...
        {
            _MyASLObject.GetComponent<ASL.ASLObject>().SendAndSetTexture2D(_TextureToSend, ChangeSpriteTexture, false, true);
        }
