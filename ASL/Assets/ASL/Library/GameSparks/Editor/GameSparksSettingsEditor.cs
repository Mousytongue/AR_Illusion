...
namespace GameSparks.Editor
{
    ...
    public class GameSparksSettingsEditor : UnityEditor.Editor
    {
    	...
    	const string UnityAssetFolder = "Assets/ASL/Library/";
        ...
        public static void Edit()
        {
			...
			//UpdateSDK (true); //Commented out so auto-updating would not occur - removing code we have added to GameSpark files
        }
    	...
    	public override void OnInspectorGUI()
    	{
    		...
    		String testScenePath = "Assets/ASL/Library/GameSparks/TestUI/GameSparksTestUI.unity";
    		...
    		if(GameSparksSettings.ApiKey != null && GameSparksSettings.ApiSecret != null){
    			String myApiPath = "Assets/ASL/Library/GameSparks/MyGameSparks.cs";
